...
public class BlockManager5 : MonoBehaviour
{
    ...
    public TMP_Text numParejas5;
    int n_numParejas5;
    public TMP_Text nFinalParejas5;
    int _nFinalParejas5;
    private int hightScore5;
    public TMP_Text hightScore5Text;
    ...
    public void Start()
    {
        hightScore5 = PlayerPrefs.GetInt("HightScore5", 0);
        hightScore5Text.text = " " + hightScore5.ToString();
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (mousedOverBlock)
            {
                ...
                if (turns != null)
                {
                    ...
                    clickedBlock = null;
                    n_numParejas5++;
                    _nFinalParejas5 = n_numParejas5;
                    numParejas5.text = n_numParejas5.ToString();
                    if(n_numParejas5 > hightScore5)
                    {
                        Save();
                    }
    ...
    public void GameOver()
    {
        ...
        n_numParejas5 = _nFinalParejas5;
        nFinalParejas5.text = _nFinalParejas5.ToString();
    }
    void Save()
    {
        PlayerPrefs.SetInt("HightScore5", n_numParejas5);

        hightScore5 = n_numParejas5;
        hightScore5Text.text = "  " + hightScore5.ToString();
    }
    public void Salir()
    {
