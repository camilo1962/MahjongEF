...
public class BlockManager : MonoBehaviour
{
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (mousedOverBlock)
            {
                ...
                if (turns != null)
                {
                    ...
                    clickedBlock = null;
                    n_numParejas++;
                    _nFinalParejas = n_numParejas;
                    numParejas.text = n_numParejas.ToString();
                    if(n_numParejas > hightScore)
                    {
                        Save();
                    }
    ...
    public void GameOver()
    {
        ...
        n_numParejas = _nFinalParejas;
        nFinalParejas.text = _nFinalParejas.ToString();
    }
    void Save()
    {
        PlayerPrefs.SetInt("HightScore", n_numParejas);

        hightScore = n_numParejas;
        hightScoreText.text = "  " + hightScore.ToString();
    }
    public void Salir()
    {
