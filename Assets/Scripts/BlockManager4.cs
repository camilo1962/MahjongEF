...
public class BlockManager4 : MonoBehaviour
{
    ...
    public TMP_Text numParejas4;
    int n_numParejas4;
    public TMP_Text nFinalParejas4;
    int _nFinalParejas4;
    private int hightScore4;
    public TMP_Text hightScore4Text;
    ...
    public void Start()
    {
        hightScore4 = PlayerPrefs.GetInt("HightScore4", 0);
        hightScore4Text.text = " " + hightScore4.ToString();
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (mousedOverBlock)
            {
                ...
                if (turns != null)
                {
                    ...
                    clickedBlock = null;
                    n_numParejas4++;
                    _nFinalParejas4 = n_numParejas4;
                    numParejas4.text = n_numParejas4.ToString();
                    if(n_numParejas4 > hightScore4)
                    {
                        Save();
                    }
    ...
    public void GameOver()
    {
        ...
        n_numParejas4 = _nFinalParejas4;
        nFinalParejas4.text = _nFinalParejas4.ToString();
    }
    void Save()
    {
        PlayerPrefs.SetInt("HightScore4", n_numParejas4);

        hightScore4 = n_numParejas4;
        hightScore4Text.text = "  " + hightScore4.ToString();
    }
    public void Salir()
    {
