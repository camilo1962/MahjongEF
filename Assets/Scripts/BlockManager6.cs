...
public class BlockManager6 : MonoBehaviour
{
    public int numBlockRow = 9;
    public int numBlockCol = 16;
    public GameObject blockPrefab;
    public Sprite[] blockSprites;
    public TMP_Text numParejas6;
    int n_numParejas6;
    public TMP_Text nFinalParejas6;
    int _nFinalParejas6;
    private int hightScore6;
    public TMP_Text hightScore6Text;
    ...
    public void Start()
    {
        hightScore6 = PlayerPrefs.GetInt("HightScore6", 0);
        hightScore6Text.text = " " + hightScore6.ToString();
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (mousedOverBlock)
            {
                ...
                if (turns != null)
                {
                    ...
                    clickedBlock = null;
                    n_numParejas6++;
                    _nFinalParejas6 = n_numParejas6;
                    numParejas6.text = n_numParejas6.ToString();
                    if(n_numParejas6 > hightScore6)
                    {
                        Save();
                    }
    ...
    public void GameOver()
    {
        ...
        n_numParejas6 = _nFinalParejas6;
        nFinalParejas6.text = _nFinalParejas6.ToString();
    }
    void Save()
    {
        PlayerPrefs.SetInt("HightScore6", n_numParejas6);

        hightScore6 = n_numParejas6;
        hightScore6Text.text = "  " + hightScore6.ToString();
    }
    public void Salir()
    {
