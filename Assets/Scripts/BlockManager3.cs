...
public class BlockManager3 : MonoBehaviour
{
    ...
    public TMP_Text numParejas3;
    int n_numParejas3;
    public TMP_Text nFinalParejas3;
    int _nFinalParejas3;
    private int hightScore3;
    public TMP_Text hightScore3Text;
    ...
    public void Start()
    {
        hightScore3 = PlayerPrefs.GetInt("HightScore3", 0);
        hightScore3Text.text = " " + hightScore3.ToString();
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (mousedOverBlock)
            {
                ...
                if (turns != null)
                {
                    ...
                    clickedBlock = null;
                    n_numParejas3++;
                    _nFinalParejas3 = n_numParejas3;
                    numParejas3.text = n_numParejas3.ToString();
                    if(n_numParejas3 > hightScore3)
                    {
                        Save();
                    }
    ...
    public void GameOver()
    {
        ...
        n_numParejas3 = _nFinalParejas3;
        nFinalParejas3.text = _nFinalParejas3.ToString();
    }
    void Save()
    {
        PlayerPrefs.SetInt("HightScore3", n_numParejas3);

        hightScore3 = n_numParejas3;
        hightScore3Text.text = "  " + hightScore3.ToString();
    }
    public void Salir()
    {
